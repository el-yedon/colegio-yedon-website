  ...
  public: {
    Tables: {
      ...
      papeis_acesso: {
        ...
        Relationships: [
          {
            foreignKeyName: "papeis_acesso_escola_id_fkey"
            columns: ["escola_id"]
            isOneToOne: false
            referencedRelation: "escolas"
            referencedColumns: ["id"]
      ...
      saas_assinaturas: {
        ...
        Relationships: [
          {
            foreignKeyName: "saas_assinaturas_escola_id_fkey"
            columns: ["escola_id"]
            isOneToOne: false
            referencedRelation: "escolas"
            referencedColumns: ["id"]
...
//   recursos: jsonb (nullable, default: '[]'::jsonb)
...
// Table: papeis_acesso
//   FOREIGN KEY papeis_acesso_escola_id_fkey: FOREIGN KEY (escola_id) REFERENCES escolas(id) ON DELETE CASCADE
//   PRIMARY KEY papeis_acesso_pkey: PRIMARY KEY (id)
// Table: parcelas
...
// Table: saas_assinaturas
//   FOREIGN KEY saas_assinaturas_escola_id_fkey: FOREIGN KEY (escola_id) REFERENCES escolas(id) ON DELETE CASCADE
//   PRIMARY KEY saas_assinaturas_pkey: PRIMARY KEY (id)
//   FOREIGN KEY saas_assinaturas_plano_id_fkey: FOREIGN KEY (plano_id) REFERENCES saas_planos(id) ON DELETE RESTRICT
// Table: saas_planos
//   PRIMARY KEY saas_planos_pkey: PRIMARY KEY (id)
// Table: series
...
//     USING: (usuario_id = auth.uid())
// Table: papeis_acesso
//   Policy "papeis_acesso_admin_all" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (check_is_admin(auth.uid()) OR is_master())
//     WITH CHECK: (check_is_admin(auth.uid()) OR is_master())
//   Policy "papeis_acesso_tenant_isolation" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: ((escola_id = get_current_tenant_id()) OR (escola_id IS NULL))
// Table: parcelas
...
//     USING: is_master()
// Table: saas_assinaturas
//   Policy "Assinaturas master all" (ALL, PERMISSIVE) roles={public}
//     USING: is_master()
//   Policy "Assinaturas tenant read" (SELECT, PERMISSIVE) roles={public}
//     USING: (escola_id = get_current_tenant_id())
// Table: saas_planos
//   Policy "Planos master write" (ALL, PERMISSIVE) roles={public}
//     USING: is_master()
//   Policy "Planos read" (SELECT, PERMISSIVE) roles={public}
//     USING: true
// Table: series
//   Policy "Master access" (ALL, PERMISSIVE) roles={authenticated}
//     USING: is_master()
...
// Table: papeis_acesso
//   CREATE UNIQUE INDEX papeis_acesso_slug_escola_idx ON public.papeis_acesso USING btree (slug, escola_id) WHERE (escola_id IS NOT NULL)
//   CREATE UNIQUE INDEX papeis_acesso_slug_escola_null_idx ON public.papeis_acesso USING btree (slug) WHERE (escola_id IS NULL)
// Table: permissoes_grupo
